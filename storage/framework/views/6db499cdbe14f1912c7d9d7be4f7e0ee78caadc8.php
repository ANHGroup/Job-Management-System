...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo/ANH_Group_logo_white.jpg')); ?>">

        <!-- App css -->
        <link href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/css/icons.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/css/app.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('assets/libs/summernote/summernote-bs4.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    </head><?php /**PATH E:\Career\jms\resources\views/layouts/css.blade.php ENDPATH**/ ?>