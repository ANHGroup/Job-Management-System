  ...
  <div class="min-h-full">
          ...
          <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <img
                  class="h-8 w-8"
                  src="https://www.anhgroupbd.com/wp-content/uploads/2023/03/ANH-Group-Logo_for_Website-1.png"
                  alt="ANH GROUP"
                />
              </div>
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  <router-link to="/foo" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Go to Foo</router-link>
                  ...
                  <template #default="{ open }">
                    ...
                    >
                      <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <template v-for="item in userNavigation" :key="item.name" #default="{ active }">
                          <MenuItem>
                            <a
                              :href="item.href"
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">All jobs</h1>
      </div>
    </header>
    <main>
      <Job />
