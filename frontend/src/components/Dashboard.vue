<template>
  <div class="min-h-full">
        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-8 w-8" src="https://www.anhgroupbd.com/wp-content/uploads/2023/03/ANH-Group-Logo_for_Website-1.png" alt="ANH GROUP" />
            </div>
    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      <div v-for="job in jobs" :key="job.id" class="w-full bg-white shadow-lg rounded-lg overflow-hidden mb-6">
        <div class="px-6 py-4">
