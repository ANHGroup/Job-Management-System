        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row" class="mx-auto col-10 col-md-8 col-lg-6">
                    <div class="col-lg-12" >
                        <div class="card-box">
                            <h5 class="text-uppercase mt-0 mb-3">Job Post</h5>
                            ...
                            <div class="form-group mb-7">
                                ...
                                <input type="text" name="title" id="product-name" class="form-control" placeholder="e.g : Apple iMac">
                            </div>

                            <div class=" col-lg-4 form-group mb-3">
                                <label for="product-reference">Salary Range <span class="text-danger">*</span></label>
                                <input type="text" name="salary_range" id="product-reference" class="form-control" placeholder="e.g : Apple iMac">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="job_category" id="product-summary" rows="3" placeholder="Please enter summary"></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label for="product-summary">Job Experience</label>
                                <textarea class="form-control" name="job_experience" id="product-summary" rows="3" placeholder="Please enter summary"></textarea>
                            </div>
                            <div class="form-group mb-3">
                                <label for="product-summary">Job Qualifications</label>
                                <textarea class="form-control" name="job_qualification" id="product-summary" rows="3" placeholder="Please enter summary"></textarea>
                            </div>
                            
                            <div class="col-lg-4 form-group mb-3">
                                <label for="product-summary">Job Deadline</label>
                                <input type="date" class="form-control" name="job_deadline" id="product-summary" rows="3" placeholder="Please enter summary">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="location" class="form-control" id="product-price" placeholder="Enter Location">
                            </div>
                            <div class="row">
                                <div class="col-12">
